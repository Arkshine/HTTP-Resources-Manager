...
PROJECT = http_resources_manager

OBJECTS = sdk/amxxmodule.cpp moduleMain.cpp moduleConfigs.cpp moduleUtils.cpp engineConfigs.cpp engineCvars.cpp engineUtils.cpp
...
CFLAGS += -DPAWN_CELL_SIZE=32 -DJIT -DASM32 -DHAVE_STDINT_H -fno-strict-aliasing -m32 -Wall -Wno-unused-value
